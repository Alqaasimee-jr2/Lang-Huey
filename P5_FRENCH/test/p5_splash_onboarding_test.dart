...
void main() {
  ...
  testWidgets('P5 French splash screen and onboarding first-time & returning flow', (WidgetTester tester) async {
    ...
    expect(find.text('PRIMARY 5 FRENCH'), findsOneWidget);
    ...
    // Reaches P5TermSelectScreen
    expect(find.text('Primary 5 French Language Engine'), findsOneWidget);
