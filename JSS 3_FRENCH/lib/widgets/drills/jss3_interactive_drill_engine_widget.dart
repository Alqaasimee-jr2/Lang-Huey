...
class JSS3InteractiveDrillEngineWidget extends StatefulWidget {
  final List<JSS3InteractiveExercise> drills;
  final int term;
  final VoidCallback onComplete;

  const JSS3InteractiveDrillEngineWidget({
    super.key,
  ...
  @override
  State<JSS3InteractiveDrillEngineWidget> createState() => _JSS3InteractiveDrillEngineWidgetState();
}

class _JSS3InteractiveDrillEngineWidgetState extends State<JSS3InteractiveDrillEngineWidget> {
  final JSS3AudioService _audioService = JSS3AudioService();
      ...
      builder: (ctx) => AlertDialog(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text('Drills Completed!', style: LangHueyTextStyles.h2.copyWith(fontSize: 20)),
                  Text('Score: $_score / ${widget.drills.length}',
                      style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: LangHueyColors.deepTeal)),
                ],
              ),
            ),
          ],
        ...
        content: Column(
          ...
          children: [
            Text(
              ...
              style: LangHueyTextStyles.bodyMedium,
            ),
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                minHeight: 10,
                backgroundColor: LangHueyColors.softTeal,
                valueColor: const AlwaysStoppedAnimation<Color>(LangHueyColors.deepTeal),
              ),
            ),
          ],
        ),
        actions: [
          TextButton(
            ...
            child: const Text('Try Again', style: TextStyle(color: LangHueyColors.textMuted, fontWeight: FontWeight.bold)),
          ),
          ElevatedButton(
  ...
  Widget build(BuildContext context) {
    if (widget.drills.isEmpty) {
      return Center(
        child: Text('No interactive drills available for this topic.', style: LangHueyTextStyles.bodyMedium),
      );
    }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  drill.prompt,
                  style: LangHueyTextStyles.h3.copyWith(fontSize: 18, height: 1.3),
                ),
              ],
            ),
          ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          drill.explanation,
                          style: LangHueyTextStyles.bodyMedium.copyWith(fontSize: 13),
                        ),
                      ],
                    ),
                  ),
            ...
            child: ElevatedButton(
              style: ElevatedButton.styleFrom(
                backgroundColor: _hasChecked
                    ? (_isAnswerCorrect ? LangHueyColors.green : LangHueyColors.deepTeal)
  ...
  Widget _buildDrillBody(JSS3InteractiveExercise drill) {
    switch (drill.type) {
      case DrillType.singleChoice:
      case DrillType.trueFalse:
      case DrillType.tapTranslation:
  ...
  Widget _buildOptionsList(JSS3InteractiveExercise drill) {
    return Column(
      children: List.generate(drill.options.length, (index) {
        ...
        if (_hasChecked) {
          ...
          bgColor = LangHueyColors.softTeal;
          textColor = LangHueyColors.deepTeal;
        }
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isSelected
                          ? (_hasChecked
                              ? (isCorrect ? LangHueyColors.green : LangHueyColors.red)
                              : LangHueyColors.deepTeal)
                          : LangHueyColors.lightGrey,
                    ),
                    child: Center(
                      child: Text(
  ...
  Widget _buildPairMatch(JSS3InteractiveExercise drill) {
    ...
    return Column(
      children: [
        Text(
          ...
          style: LangHueyTextStyles.bodySmall.copyWith(fontStyle: FontStyle.italic),
        ),
        const SizedBox(height: 16),
        Row(
          crossAxisAlignment: CrossAxisAlignment.start,
                              ...
                              child: Text(
                                ...
                                style: TextStyle(
                                  ...
                                  color: isMatched
                                      ...
                                      : isSelected
                                          ? LangHueyColors.deepTeal
                                          : LangHueyColors.charcoal,
                                ),
                              ),
                            ),
                            if (isMatched) const Icon(Icons.check_rounded, color: LangHueyColors.green, size: 18),
                          ],
                        ),
                      ),
                    ),
  ...
  void _checkPairMatch(JSS3InteractiveExercise drill) {
  ...
  Widget _buildFillGap(JSS3InteractiveExercise drill) {
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 18,
                    fontWeight: FontWeight.bold,
                    color: _selectedGapWord != null ? Colors.white : LangHueyColors.deepTeal,
                  ),
                ),
              ),
              if (parts.length > 1)
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(14),
                    border: Border.all(
                      color: isSelected ? LangHueyColors.deepTeal : Colors.black26,
