...
RATE = "-4%"
OUTPUT_DIR = os.path.join(os.path.dirname(__file__), "assets", "audio", "jss3_term1")
LESSONS_FILE = os.path.join(os.path.dirname(__file__), "lib", "data", "jss3_term1_lessons.dart")
...
async def main():
    ...
    print(f"Total vocabulary items extracted: {len(vocab_items)}")
