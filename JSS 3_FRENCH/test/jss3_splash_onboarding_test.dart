...
void main() {
  ...
  testWidgets('JSS3 French splash screen and onboarding first-time & returning flow', (WidgetTester tester) async {
    ...
    expect(find.text('JSS 3 FRENCH'), findsOneWidget);
