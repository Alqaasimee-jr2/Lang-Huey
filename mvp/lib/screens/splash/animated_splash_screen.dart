...
class AnimatedSplashScreen extends StatefulWidget {
  ...
  const AnimatedSplashScreen({
    super.key,
    this.editionLabel = 'PRIMARY 4 FRENCH',
  });
...
class _AnimatedSplashScreenState extends State<AnimatedSplashScreen>
  ...
  void initState() {
    ...
    // Entrance pop-in: 900ms
    _entranceController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 900),
    )..forward();

    // Ambient floating circles: 6s cycle
    _floatController = AnimationController(
      vsync: this,
      duration: const Duration(milliseconds: 6000),
    )..repeat(reverse: true);

    // Bouncing loading dots: 1100ms cycle
  ...
  Future<void> _checkAndNavigate() async {
    ...
    if (hasCompleted) {
      Navigator.of(context).pushReplacement(
        PageRouteBuilder(
          pageBuilder: (_, __, ___) => const P4TermSelectScreen(),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GestureDetector(
        ...
        onTap: _checkAndNavigate, // instant tap-to-skip
        child: Container(
          ...
          child: Stack(
            ...
            children: [
                ...
                children: [
                  ...
                  ScaleTransition(
                    ...
                    child: const LangHueyMascotHeadWidget(
                      size: 210,
                      isLightHead: true, // Cream head on dark teal
                      isTalking: false,
                    ),
                  ),
              ...
              // Tap anywhere hint in bottom corner
              Positioned(
                bottom: 24,
                child: Text(
  ...
  List<Widget> _buildFloatingCircles() {
    // 6 ambient circles with varying positions and gentle drift
    final circles = [
